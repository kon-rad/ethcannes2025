            ...
            <div className="space-y-4">
              {characters.map((character) => (
                <div
                  ...
                  className="flex items-center space-x-4 p-4 bg-[#F8F9FA] rounded-xl border border-[#9CA3AF]/20 hover:border-[#9CA3AF]/40 hover:shadow-lg transition-all duration-200 cursor-pointer group"
                >
                  {/* Avatar Image */}
